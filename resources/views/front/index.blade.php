...
<html lang="en-US">
  <head>
    ...
    <link href="{{ asset('front/css/bootstrap.min.css?ver=1.1.0')}}" rel="stylesheet">
    <link href="{{ asset('front/css/font-awesome/css/all.min.css?ver=1.1.0')}}" rel="stylesheet">
    <link href="{{ asset('front/css/aos.css?ver=1.1.0')}}" rel="stylesheet">
    <link href="{{ asset('front/css/ekko-lightbox.css?ver=1.1.0')}}" rel="stylesheet">
    <link href="{{ asset('front/css/main.css?ver=1.1.0')}}" rel="stylesheet">
    <noscript>
      <style type="text/css">
        [data-aos] {
            opacity: 1 !important;
...
<div class="ww-home-page" id="home">
  <div class="ww-wedding-announcement d-flex align-items-center justify-content-start">
    <div class="container ww-announcement-container">
      <p class="ww-couple-name ww-title" data-aos="zoom-in-down" data-aos-delay="300" data-aos-duration="1000">sdasdad & Asdsad</p><img class="img-fluid mt-1" src="{{asset('front/images/laurel-1.png')}}" alt="Heart" data-aos="zoom-in-down" data-aos-delay="300" data-aos-duration="1000"/>
      ...
      <p class="h2 mt-5 ww-title" data-aos="zoom-in-down" data-aos-delay="300" data-aos-duration="1000" data-aos-offset="10">Kepada {{ $guest->name }} ditempat</p>
    </div>
  </div>
</div>
...
<div class="ww-section" id="couple">
  <div class="container">
    ...
    <div class="row text-center">
      <div class="col-md-6">
        <div class="mt-3"><img class="img-fluid" src="{{asset('front/images/groom.jpg')}}" alt="Groom" data-aos="flip-left" data-aos-duration="1000"/>
      ...
      <div class="col-md-6">
        <div class="mt-3"><img class="img-fluid" src="{{asset('front/images/bride.jpg')}}" alt="Bride" data-aos="flip-right" data-aos-duration="1000"/>
  ...
  <div class="container ww-wedding-event">
    ...
    <div class="row">
      ...
      <div class="col-md-5 col-sm-12">
        <div class="my-3"><img class="img-fluid" src="{{asset('front/images/wedding-party.jpg')}}" alt="Wedding Party" data-aos="fade-down-right" data-aos-duration="1000"/></div>
      </div>
    </div>
    <div class="row">
      <div class="col-md-7 col-sm-12">
      ...
      <div class="col-md-5 col-sm-12">
        <div class="my-3"><img class="img-fluid" src="{{asset('front/images/reception.jpg')}}" alt="Reception" data-aos="fade-up-right" data-aos-duration="1000"/></div>
      </div>
    </div>
  </div>
</div>
    ...
    <div class="carousel slide" id="ww-carouselIndicator" data-ride="carousel" data-aos="zoom-in-up" data-aos-duration="1000">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <div class="row">
            <div class="col-md-4">
              <div class="card d-block mb-3"><img class="card-img-top" src="{{asset('front/images/groom-men-1.jpg')}}" alt="Groom Men 1"/>
            ...
            <div class="col-md-4">
              <div class="card d-block mb-3"><img class="card-img-top" src="{{asset('front/images/groom-men-2.jpg')}}" alt="Groom Men 2"/>
                <div class="card-body text-center">
            ...
            <div class="col-md-4">
              <div class="card d-block mb-3"><img class="card-img-top" src="{{asset('front/images/groom-men-3.jpg')}}" alt="Groom Men 3"/>
                <div class="card-body text-center">
        ...
        <div class="carousel-item">
          <div class="row">
            <div class="col-md-4">
              <div class="card d-block mb-3"><img class="card-img-top" src="{{asset('front/images/bride-maid-1.jpg')}}" alt="Bride Maid 1"/>
                <div class="card-body text-center">
            ...
            <div class="col-md-4">
              <div class="card d-block mb-3"><img class="card-img-top" src="{{asset('front/images/bride-maid-2.jpg')}}" alt="Bride Maid 2"/>
                <div class="card-body text-center">
            ...
            <div class="col-md-4">
              <div class="card d-block mb-3"><img class="card-img-top" src="{{asset('front/images/bride-maid-3.jpg')}}" alt="Bride Maid 3"/>
                <div class="card-body text-center">
    ...
    <div class="container">
      ...
      <div class="ww-gallery" data-aos="fade-zoom-in" data-aos-easing="ease-in-back" data-aos-delay="300" data-aos-duration="1000" data-aos-offset="0">
        <div class="card-columns">
          <div class="card" data-groups="[&quot;vacation&quot;,&quot;ceremony&quot;]"><a href="{{asset('front/images/gallery-pic-1.jpg')}}" data-toggle="lightbox" data-gallery="ww-gallery"><img class="img-fluid" src="{{asset('front/images/gallery-pic-1.jpg')}}" alt="Gallery Pic 1"/></a></div>
          <div class="card" data-groups="[&quot;party&quot;,&quot;wedding&quot;]"><a href="{{asset('front/images/gallery-pic-2.jpg')}}" data-toggle="lightbox" data-gallery="ww-gallery"><img class="img-fluid" src="{{asset('front/images/gallery-pic-2.jpg')}}" alt="Gallery Pic 2"/></a></div>
          <div class="card" data-groups="[&quot;vacation&quot;]"><a href="{{asset('front/images/gallery-pic-3.jpg')}}" data-toggle="lightbox" data-gallery="ww-gallery"><img class="img-fluid" src="{{asset('front/images/gallery-pic-3.jpg')}}" alt="Gallery Pic 3"/></a></div>
          <div class="card" data-groups="[&quot;party&quot;,&quot;vacation&quot;]"><a href="{{asset('front/images/gallery-pic-4.jpg')}}" data-toggle="lightbox" data-gallery="ww-gallery"><img class="img-fluid" src="{{asset('front/images/gallery-pic-4.jpg')}}" alt="Gallery Pic 4"/></a></div>
          <div class="card" data-groups="[&quot;vacation&quot;]"><a href="{{asset('front/images/gallery-pic-5.jpg')}}" data-toggle="lightbox" data-gallery="ww-gallery"><img class="img-fluid" src="{{asset('front/images/gallery-pic-5.jpg')}}" alt="Gallery Pic 5"/></a></div>
          <div class="card" data-groups="[&quot;wedding&quot;,&quot;ceremony&quot;,&quot;party&quot;]"><a href="{{asset('front/images/gallery-pic-6.jpg')}}" data-toggle="lightbox" data-gallery="ww-gallery"><img class="img-fluid" src="{{asset('front/images/gallery-pic-6.jpg')}}" alt="Gallery Pic 6"/></a></div>
          <div class="card" data-groups="[&quot;vacation&quot;]"><a href="{{asset('front/images/gallery-pic-7.jpg')}}" data-toggle="lightbox" data-gallery="ww-gallery"><img class="img-fluid" src="{{asset('front/images/gallery-pic-7.jpg')}}" alt="Gallery Pic 7"/></a></div>
          <div class="card" data-groups="[&quot;wedding&quot;,&quot;party&quot;]"><a href="{{asset('front/images/gallery-pic-8.jpg')}}" data-toggle="lightbox" data-gallery="ww-gallery"><img class="img-fluid" src="{{asset('front/images/gallery-pic-8.jpg')}}" alt="Gallery Pic 8"/></a></div>
        </div>
      </div>
    </div>
  </div>
...
<div class="ww-footer bg-light">
  <div class="container text-center py-4">
    ...
    <footer></footer>
    <script src="{{ asset('front/scripts/jquery.min.js?ver=1.1.0') }}"></script>
    <script src="{{ asset('front/scripts/bootstrap.bundle.min.js?ver=1.1.0') }}"></script>
    <script src="{{ asset('front/scripts/aos.js?ver=1.1.0') }}"></script>
    <script src="{{ asset('front/scripts/ekko-lightbox.min.js?ver=1.1.0') }}"></script>
    <script src="{{ asset('front/scripts/main.js?ver=1.1.0') }}"></script>
  </body>
</html>
